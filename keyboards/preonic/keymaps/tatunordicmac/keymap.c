// To flash preonic firmware
// ▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔▔
//
//   cd qmk_firmware
//   make preonic/rev3:tatunordicmac:clean (good practice before flashing)
//   Reset keyboard or press hw reset button on base (hole).
//   make preonic/rev3:tatunordicmac:dfu-util
//
//
// Notes
// ▔▔▔▔▔
...
// Code
// ▔▔▔▔
//   tpolvinen: This source is shamelessly based on sdothum´s Ergo Wide Split Layout for Planck, 
...
//   and occasionally in code comments.
//
// Change history
// ▔▔▔▔▔▔▔▔▔▔▔▔▔▔
...
// compile time macro string, see functions/hardware preonic script
